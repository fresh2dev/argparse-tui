...
**Full Changelog**: https://github.com/fresh2dev/argparse-tui/compare/0.3.1...0.4.0

### :clap: Features

- Preserve argparse arg group titles and order
- Set default textual theme to `catppuccin-mocha`
- Press `q` or `Q` to exit
- Support `VersionAction` and Yapx's `DummyArgAction`

### :fist: Fixes

- Don't display label for boolean parameters

### :metal: Other

- Bump `textual>=2.1.2,<3` and refactor
