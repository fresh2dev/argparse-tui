...
-
  ...
  metadata:
    ...
    annotations:
      ...
      gethomepage.dev/group: 'K8S Services'
      ...
      gethomepage.dev/pod-selector: 'io.kompose.service in (<{{ $vars.releaseName }}>)'
      # OR: gethomepage.dev/pod-selector: 'app.kubernetes.io/name in (<{{ $vars.releaseName }}>), app.kubernetes.io/instance in (<{{ $vars.releaseName }}>)'
